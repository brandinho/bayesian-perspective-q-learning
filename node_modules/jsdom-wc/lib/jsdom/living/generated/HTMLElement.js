...
const registry = utils.registrySymbol;
...
HTMLElement.prototype.attachShadow = function attachShadow(options) {
  if (!this || !module.exports.is(this)) {
    throw new TypeError("Illegal invocation");
  }
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'attachShadow' on 'HTMLElement': 1 argument required, but only " +
        arguments.length +
        " present."
    );
  }
  ...
  return this[impl].attachShadow(...args);
};
